...
function EmployeOran() {
    ...
    useEffect(() => {
        setSpinner(true)
        axios.get(`${process.env.REACT_APP_API}/employes/oran`).then((response) => {
    ...
    if (JSON.parse(localStorage.getItem('admin')).role == 'alger' || JSON.parse(localStorage.getItem('admin')).role == 'bejaia') {
        return (
            <div>
