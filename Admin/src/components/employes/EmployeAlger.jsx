...
function EmployeAlger() {
    ...
    useEffect(() => {
        setSpinner(true)
        axios.get(`${process.env.REACT_APP_API}/employes/alger`).then((response) => {
    ...
    if (JSON.parse(localStorage.getItem('admin')).role == 'oran' || JSON.parse(localStorage.getItem('admin')).role == 'bejaia') {
        return (
            <div>
